 ...
 * @param {Object} client An alternative superagent instance to use.
 */
function add_deploy_key(gh_repo_path, pubkey, title, token, callback, client) {
  client = client || superagent;
 ...
 * @param {Object} client An alternative superagent instance to use.
 */
function set_push_hook(gh_repo_path, name, url, secret, token, callback, client) {
  client = client || superagent;
 ...
 * @param {Object} client An alternative superagent instance to use.
 */
function unset_push_hook(gh_repo_path, token, callback, client) {
  client = client || superagent;
  var qpm = {access_token: token};
